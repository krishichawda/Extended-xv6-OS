...
bootblock: kernel/bootasm.S kernel/bootmain.c
	$(CC) $(CFLAGS) -fno-pic -O -nostdinc -I. -c kernel/bootmain.c
	$(CC) $(CFLAGS) -fno-pic -nostdinc -I. -c kernel/bootasm.S
...
initcode: user/initcode.S
	$(CC) $(CFLAGS) -nostdinc -I. -c user/initcode.S
	$(LD) $(LDFLAGS) -N -e start -Ttext 0 -o initcode.out initcode.o
	$(OBJCOPY) -S -O binary initcode.out initcode
	$(OBJDUMP) -S initcode.o > initcode.asm

kernel: $(OBJS) kernel/entry.o entryother initcode kernel.ld
	$(LD) $(LDFLAGS) -T kernel.ld -o kernel kernel/entry.o $(OBJS) -b binary initcode entryother
...
tags: $(OBJS) entryother.S user/initcode.S
	etags *.S *.c
...
_forktest: forktest.o $(ULIB)
	# forktest has less library code linked in - it needs to be small
	# in order to be able to max out the proc table.
	$(LD) $(LDFLAGS) -N -e main -Ttext 0 -o _forktest forktest.o user/ulib.o user/usys.o
	$(OBJDUMP) -S _forktest > forktest.asm

mkfs: mkfs.c include/fs.h include/param.h
...
qemu-gdb: fs.img xv6.img .gdbinit
	...
	$(QEMU) -serial mon:stdio $(QEMUOPTS) -S -gdb tcp::$(GDBPORT)
